...
templates['projectView'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "						<div class=\"project-discussion-post\">\n							<div class=\"post-content project-discussion-head\">\n							    <span class=\"post-user\"><a href=\"#\" id=\"view-user\" view-user-id="
    ...
    + "\n							</div>\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.comments : depth0),{"name":"each","hash":{},"fn":container.program(15, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers["if"].call(alias1,((stack1 = (data && data.root)) && stack1.user_logged_in),{"name":"if","hash":{},"fn":container.program(17, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "						</div>\n";
